...
export const locales = {
  en: {
    ...
    settings: {
      ...
      display: 'Display', theme: 'Theme', fullscreen: 'Fullscreen', windowed: 'Windowed', fullscreenHint: 'Run the app fullscreen on the touchscreen, or windowed for setup. Press F11 to toggle anytime.',
      ...
      enterLicense: 'Enter / renew license', pasteLicense: 'paste license here', licenseActivated: 'License activated', activating: 'Activating…', activateLicense: 'Activate license', enterCode: 'Enter your activation code', appVersion: 'App v{v}'
    }
  },
  ...
  fr: {
    ...
    settings: {
      ...
      display: 'Affichage', theme: 'Thème', fullscreen: 'Plein écran', windowed: 'Fenêtré', fullscreenHint: 'Lancez l’app en plein écran sur l’écran tactile, ou en fenêtré pour la configuration. Touche F11 pour basculer.',
      ...
      enterLicense: 'Saisir / renouveler la licence', pasteLicense: 'collez la licence ici', licenseActivated: 'Licence activée', activating: 'Activation…', activateLicense: 'Activer la licence', enterCode: 'Saisissez votre code d’activation', appVersion: 'App v{v}'
    }
  },
  ...
  ar: {
    ...
    settings: {
      ...
      display: 'العرض', theme: 'السمة', fullscreen: 'ملء الشاشة', windowed: 'نافذة', fullscreenHint: 'شغّل التطبيق بملء الشاشة على الشاشة اللمسية، أو في نافذة للإعداد. اضغط F11 للتبديل في أي وقت.',
      ...
      enterLicense: 'إدخال / تجديد الترخيص', pasteLicense: 'الصق الترخيص هنا', licenseActivated: 'تم تفعيل الترخيص', activating: 'جارٍ التفعيل…', activateLicense: 'تفعيل الترخيص', enterCode: 'أدخل رمز التفعيل', appVersion: 'الإصدار v{v}'
    }
  }
}
