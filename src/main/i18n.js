...
const M = {
  en: {
    receipt: { total: 'TOTAL', subtotal: 'Subtotal', discount: 'Discount', change: 'Change', tel: 'Tel', table: 'Table', order: 'Order', cash: 'Cash', card: 'Card', person: 'Person' },
    report: {
  ...
  fr: {
    receipt: { total: 'TOTAL', subtotal: 'Sous-total', discount: 'Remise', change: 'Monnaie', tel: 'Tél', table: 'Table', order: 'Commande', cash: 'Espèces', card: 'Carte', person: 'Personne' },
    report: {
  ...
  ar: {
    receipt: { total: 'الإجمالي', subtotal: 'المجموع الفرعي', discount: 'الخصم', change: 'الباقي', tel: 'هاتف', table: 'طاولة', order: 'طلب', cash: 'نقدًا', card: 'بطاقة', person: 'شخص' },
    report: {
